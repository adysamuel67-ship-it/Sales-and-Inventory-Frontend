...
export function LoadingDots() {
  return (
    <div className="flex items-center gap-1.5">
      <span className="w-2 h-2 rounded-full bg-white/70 auth-animate-shimmer" />
      <span className="w-2 h-2 rounded-full bg-white/70 auth-animate-shimmer" style={{ animationDelay: '0.2s' }} />
      <span className="w-2 h-2 rounded-full bg-white/70 auth-animate-shimmer" style={{ animationDelay: '0.4s' }} />
    </div>
  )
}
    ...
    <div className="min-h-screen auth-gradient relative overflow-hidden flex items-center justify-center p-6">
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full max-w-2xl">
        ...
        <div className="flex items-center gap-2.5 mt-8 mb-4 auth-animate-fade-up auth-delay-3">
          ...
          <p className="text-blue-100 text-sm font-medium">{message}</p>
        </div>
